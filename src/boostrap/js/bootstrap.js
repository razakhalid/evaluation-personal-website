    ...
    setTimeout(
      $.proxy(function () {
        ...
        if (state == "loadingText") {
          this.isLoading = true;
          $el.addclassName(d).attr(d, d).prop(d, true);
        } else if (this.isLoading) {
          this.isLoading = false;
          $el.removeclassName(d).removeAttr(d).prop(d, false);
        }
      }, this),
      0
    );
  ...
  Button.prototype.toggle = function () {
    ...
    if ($parent.length) {
      ...
      if ($input.prop("type") == "radio") {
        ...
        $parent.find(".active").removeclassName("active");
        this.$element.addclassName("active");
      } else if ($input.prop("type") == "checkbox") {
        if ($input.prop("checked") !== this.$element.hasclassName("active"))
          changed = false;
        this.$element.toggleclassName("active");
      }
      $input.prop("checked", this.$element.hasclassName("active"));
      if (changed) $input.trigger("change");
    } else {
      this.$element.attr("aria-pressed", !this.$element.hasclassName("active"));
      this.$element.toggleclassName("active");
    }
  };
  ...
  $(document)
    ...
    .on(
      ...
      function (e) {
        $(e.target)
          .closest(".btn")
          .toggleclassName("focus", /^focus(in)?$/.test(e.type));
      }
    );
})(jQuery);
...
+(function ($) {
  ...
  Carousel.prototype.slide = function (type, next) {
    ...
    if ($next.hasclassName("active")) return (this.sliding = false);
    ...
    if ($.support.transition && this.$element.hasclassName("slide")) {
      ...
      $active
        .one("bsTransitionEnd", function () {
          $next
            .removeclassName([type, direction].join(" "))
            .addclassName("active");
  ...
  var clickHandler = function (e) {
    ...
    if (!$target.hasclassName("carousel")) return;
...
+(function ($) {
  ...
  var Collapse = function (element, options) {
    ...
    if (this.options.parent) {
      ...
      this.addAriaAndCollapsedclassName(this.$element, this.$trigger);
    }
  ...
  Collapse.prototype.show = function () {
    ...
    this.$trigger.removeclassName("collapsed").attr("aria-expanded", true);
  ...
  Collapse.prototype.hide = function () {
    ...
    this.$element
      .addclassName("collapsing")
      .removeclassName("collapse in")
      .attr("aria-expanded", false);

    this.$trigger.addclassName("collapsed").attr("aria-expanded", false);
    ...
    return $(this.options.parent)
      ...
      .each(
        $.proxy(function (i, element) {
          var $element = $(element);
          this.addAriaAndCollapsedclassName(
  ...
  Collapse.prototype.addAriaAndCollapsedclassName = function (
    $element,
    $trigger
  ) {
    var isOpen = $element.hasclassName("in");

    $element.attr("aria-expanded", isOpen);
    $trigger
      .toggleclassName("collapsed", !isOpen)
    ...
    if (!isActive) {
      if (
        ...
        $(document.createElement("div"))
          .addclassName("dropdown-backdrop")
          .insertAfter($(this))
          .on("click", clearMenus);
      }
...
+(function ($) {
  ...
  Modal.prototype.show = function (_relatedTarget) {
    ...
    this.backdrop(function () {
      var transition =
        $.support.transition && that.$element.hasclassName("fade");
  ...
  Modal.prototype.hideModal = function () {
    ...
    this.$element.hide();
    this.backdrop(function () {
      that.$body.removeclassName("modal-open");
  ...
  Modal.prototype.backdrop = function (callback) {
    ...
    if (this.isShown && this.options.backdrop) {
      ...
      this.$backdrop = $(document.createElement("div"))
        .addclassName("modal-backdrop " + animate)
        .appendTo(this.$body);
...
+(function ($) {
  ...
  Tooltip.prototype.enter = function (obj) {
    ...
    if (self.tip().hasclassName("in") || self.hoverState == "in") {
      self.hoverState = "in";
      return;
    }
  ...
  Tooltip.prototype.show = function () {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        $tip.removeclassName(orgPlacement).addclassName(placement);
      }
  ...
  Tooltip.prototype.hide = function (callback) {
    ...
    $.support.transition && $tip.hasclassName("fade")
      ? $tip
          .one("bsTransitionEnd", complete)
          .emulateTransitionEnd(Tooltip.TRANSITION_DURATION)
      : complete();
...
+(function ($) {
  ...
  ScrollSpy.prototype.activate = function (target) {
    ...
    var active = $(selector).parents("li").addclassName("active");

    if (active.parent(".dropdown-menu").length) {
      active = active.closest("li.dropdown").addclassName("active");
    }
...
+(function ($) {
  ...
  Tab.prototype.activate = function (element, container, callback) {
    ...
    var transition =
      callback &&
      $.support.transition &&
      (($active.length && $active.hasclassName("fade")) ||
...
+(function ($) {
  ...
  Affix.prototype.getPinnedOffset = function () {
    ...
    this.$element.removeclassName(Affix.RESET).addclassName("affix");
    var scrollTop = this.$target.scrollTop();
    var position = this.$element.offset();
  ...
  Affix.prototype.checkPosition = function () {
    ...
    if (this.affixed != affix) {
      ...
      this.$element
        .removeclassName(Affix.RESET)
        .addclassName(affixType)
